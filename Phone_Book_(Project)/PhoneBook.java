...
class PhoneBook {
    public static void main(String args[]) {
       PhoneBookDirectory directory = new PhoneBookDirectory();
        directory.addContact("Suman",3188014);
        directory.addContact("Buzdar",318801);
        directory.addContact("Sain", 1342424);
        directory.addContact("Arslan",224323);
        directory.addContact("Bugti", 988232);
        String query = "Sain";
